/**
 * @description bin.hacknet.js - 5.6 GB - Purchases nodes and upgrades them until the highest gain rate increase per cost ratio of the possible upgrades are below a given threshold.
