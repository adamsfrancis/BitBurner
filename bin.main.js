/**
 * @description bin.main.js - 6.9GB - Runs scripts related to hacking servers.
 ...
 * @todo Figure out a better way for this to run "bin.hacker.js".
...
import { float_get_server_ram_free } from "lib.ram.server.js";
import {
...
import { void_kill_script_named_server_named } from "lib.kill.js";
import { void_copy_files } from "lib.cp.js";
...
const object_constants = {
	...
	object_helpers: {
		string_nop: "sbin.nop.js",
		string_hacker: "sbin.hacker.js",
		string_ram: "sbin.ram.js",
		string_servers: "sbin.servers.js",
		string_tor: "sbin.tor.js",
		string_programs: "sbin.programs.js",
		string_botnet: "sbin.botnet.js",
		string_weaken_manager: "sbin.weaken.manager.js",
		string_cyclic_weaken: "sbin.weaken.cyclic.js",
	},
