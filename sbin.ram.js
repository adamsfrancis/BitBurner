/**
 * @description sbin.ram.js - 6.6GB - Perpetually tries to upgrade the RAM of "home" if the RAM utilisation of the network of rooted servers is over a threshold value and there is sufficient cash.
 */
