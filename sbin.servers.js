/**
 * @description sbin.servers.js - 8.85GB - Perpetually tries to buy the best server with the available cash if RAM utilisation of the network is over a threshold, unless there are 25 servers already, in which case deletes the worst server and replaces it with a better one, unless all 25 already have the maximum possible RAM.
 */
